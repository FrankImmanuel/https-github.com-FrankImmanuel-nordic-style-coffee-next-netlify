...
import { SliceMachineError, InternalError, UnexpectedDataError, PluginError } from "../../errors.js";
...
Error Message: ${error2.message}`);
  ...
  async fetchActiveEnvironment() {
    ...
    if (!activeEnvironment) {
      throw new UnexpectedDataError(`The active environment (${activeEnvironmentDomain ?? "Production"}) does not match one of the repository's environments.`);
    }
