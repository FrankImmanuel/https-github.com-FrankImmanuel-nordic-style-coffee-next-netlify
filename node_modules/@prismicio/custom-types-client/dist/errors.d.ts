 ...
 */
export declare class PrismicError<TResponse = never> extends Error {
    /**
     * The Prismic Custom Types API URL used for the failed request.
     */
    url: string;
 ...
 * request.
 */
export declare class UnauthorizedError extends PrismicError<string> {
}
/**
 * Represents an error when making a forbidden Prismic Custom Types API request.
 */
export declare class ForbiddenError extends PrismicError<ForbiddenErrorAPIResponse> {
}
/**
 * Represents an error when an entity with the same ID already exists.
 */
export declare class ConflictError extends PrismicError {
}
/**
 * Represents an error when the requested entity could not be found.
 */
export declare class NotFoundError extends PrismicError {
}
/**
 * Represents an error when the provided data is invalid.
 */
export declare class InvalidPayloadError extends PrismicError<string> {
}
/**
